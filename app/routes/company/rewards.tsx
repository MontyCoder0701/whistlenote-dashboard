        ...
        {results.length === 0 ? (
          ...
          <>
            ...
            <div className="md:hidden space-y-3">
              {results.map((r) => (
                <div key={r.id} onClick={() => nav(`/company/rewards/${r.id}`)} className="rounded-xl border p-4 bg-white">
            ...
            <div className="hidden md:block overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {results.map((r) => (
                    <TableRow key={r.id} onClick={() => nav(`/company/rewards/${r.id}`)} className="align-top">
                      <TableCell>
